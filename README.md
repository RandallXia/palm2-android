...
`PaLM2` 不像 OpenAI 只提供了官方的 Web API 和 Python SDK，它提供了官方各个语音的 SDK，包括 `Python`、`Node.js`、`Java`
...
其中 `output` 就是返回的文本结果。其中和 OpenAI 接口不同的是 PaLM 提供了生成文本的安全相关的信息，这个可以应该解决 LLM
